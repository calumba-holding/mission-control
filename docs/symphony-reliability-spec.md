# Symphony Reliability Spec

> **Status:** Design doc for unimplemented work. Preserved as an implementation blueprint after the original `symphony` branch was retired on 2026-05-16 (too divergent from current `main` to rebase).
>
> Reimplement the 5 phases below fresh against current `main` when reliability work is prioritized. Originally drafted against `main` @ `98058ca` (2026-03-04).
